...
exports.MarketStateFirstService = void 0;
...
let MarketStateFirstService = class MarketStateFirstService {
    constructor() {
        this.rnd = new random_1.Smush32(0xdecafbad);
        this.subject = new rxjs_1.BehaviorSubject(this.initialState());
        _source.set(this, rxjs_1.interval(3000).subscribe({
...
_source = new WeakMap();
MarketStateFirstService = __decorate([
    common_1.Injectable()
], MarketStateFirstService);
exports.MarketStateFirstService = MarketStateFirstService;
//# sourceMappingURL=market-state-first.service.js.map