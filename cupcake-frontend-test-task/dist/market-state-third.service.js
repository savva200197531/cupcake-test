...
exports.MarketStateThirdService = void 0;
...
let MarketStateThirdService = class MarketStateThirdService {
    constructor() {
        this.rnd = new random_1.Smush32(0xdecafbad);
        this.subject = new rxjs_1.BehaviorSubject(this.initialState());
        _source.set(this, rxjs_1.interval(2000)
            .pipe(operators_1.delay(200))
            .subscribe({
...
_source = new WeakMap();
MarketStateThirdService = __decorate([
    common_1.Injectable()
], MarketStateThirdService);
exports.MarketStateThirdService = MarketStateThirdService;
//# sourceMappingURL=market-state-third.service.js.map